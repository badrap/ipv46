...
describe("IPv4", () => {
  ...
  describe("parse()", () => {
    it("accepts 4 octet IPv4 addresses", () => {
      expect(IPv4.parse("0.0.0.0")).not.toBeNull();
      expect(IPv4.parse("255.255.255.255")).not.toBeNull();
      expect(IPv4.parse("10.255.0.126")).not.toBeNull();
    });
    ...
    it("disallows trailing dots", () => {
      expect(IPv4.parse("0.0.0.")).toBeNull();
      expect(IPv4.parse("0.0.0.0.")).toBeNull();
    });

    it("disallows double dots", () => {
      expect(IPv4.parse("0..0.0")).toBeNull();
      expect(IPv4.parse("0..0.0.0")).toBeNull();
    });

    it("disallows starting with a dot", () => {
      expect(IPv4.parse(".0.0.0")).toBeNull();
      expect(IPv4.parse(".0.0.0.0")).toBeNull();
    });
  });
